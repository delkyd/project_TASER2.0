...
var twitter = new Twit({
  // yes, i know, we should probably hide this.
...
// lets connect to our mongo DB
mongoose.connect( DB ); 

//lets start using some magical parsing stuff
app.use( cookieParser() );
app.use( bodyParser() ); 

// lets start ejs up and 
app.set( "view engine", "ejs" );
app.use( ejsLayouts );
app.set( "views", "./views" );

//tells all pages to reference the public folder
app.use( express.static( __dirname + "/public" ) );
app.engine('ejs', require('ejs').renderFile);


app.use( session( { secret: "pizza_party_for_days" } ) ); 
